    ...
    with st.form("career_form"):
        ...
        with col1:
            interest = st.selectbox("Favorite subject area",
                ["Math/Physics", "Biology/Health", "Art/Design", "Computers/Data", "Languages/History"], index=3)
            style = st.selectbox("How do you like to work?",
                ["Hands-on", "Creative", "Analytical", "Helping People"], index=2)
        with col2:
            enjoy = st.multiselect("Pick up to 3 things you enjoy",
                ...
                default=["Solving puzzles"])
            values = st.selectbox("What matters most to you?",
                ["Innovation", "Helping others", "Creativity", "Precision/Accuracy"], index=0)
